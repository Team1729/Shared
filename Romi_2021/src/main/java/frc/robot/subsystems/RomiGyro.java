...
public class RomiGyro {
  ...
  public static SimDevice gyroSimDevice = SimDevice.create("Gyro:RomiGyro");
  ...
  public double getAngleX() {
    SmartDashboard.putNumber("Gyro X", m_simAngleX.get());
  ...
  public double getAngleY() {
    SmartDashboard.putNumber("Gyro Y", m_simAngleY.get());
  ...
  public double getAngleZ() {
    SmartDashboard.putNumber("Gyro Z", m_simAngleZ.get());
