 ...
 *
 */
public class SmartAutoRight_V2 extends Command {

    public SmartAutoRight_V2() {
    ...
    String gameData = DriverStation.getInstance().getGameSpecificMessage();
    	...
    	if(gameData.charAt(0) == 'L' && gameData.charAt(1) == 'L'){
    		...
    		case 1:
    			...
    			break;
    		case 2:
    			command = new MoveTurn(270, 0.6);
    			break;
    		case 3:
    			command = new MoveDrive(0.5, 1000, 270);
    			break;
    		case 4:
    	...
    	if(gameData.charAt(0) == 'R' && gameData.charAt(1) == 'L'){
    		...
    		new MoveLift(0.6, 2.2, 0.4, 2).start(); // origional 0.4 and 2 on wrist
    			break;
    		case 3:
    		command = new MoveTurn(270, 0.5);
    			break;
    		case 4:
    		command = new EncoderStop(270, 0.3);
    			break;
    		case 5:
	  	...
	  	if(gameData.charAt(1) == 'R'){
		  	...
		  	command = new MoveDrive(0.4, 600, 0);
	  			break;
	  		case 4:
		  	command = new MoveDrive(0.4, 1700, 338);
	  			break;
	  		case 5:
		  	command = new MoveGrabber("release");
	  			break;
	  		case 6:
		  	command = new MoveDrive(-0.2, 300, 342);
	  			break;
	  		case 7:
		  	command = new MoveLift(-0.8, 3, 0.4, 1.4);
	  			break;
	  		case 8:
		  	command = new MoveTurn(200, 0.7);
	  			break;
	  		case 9:
	  		command = new Wait(0.02);
	  			break;
	  		case 10:
		  	command = new EncoderStop(200, 0.3);
		  	...
		  	command = new Wait(0.02);
	  			break;
	  		case 13:
		  	command = new MoveDrive(-0.3, 200, 200);
    		...
    		command = new Wait(0.02);
	  		...
	  		if(gameData.charAt(0) == 'R' && stage >= 13){
  				switch(stage){
  				case 14:
  				command = new EncoderStop(190, 0.4);
  					break;
  				case 15:
  				command = new MoveIntake(-0.4, 2);
  					break;
